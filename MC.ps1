...
Function Reports {
	...
	function cpureporting {
		...
		$CpuTestFailures -replace "genintel_1_Results.txt", "Not an intel CPU"
		$CpuTestFailures -replace "brandstring_1_Results.txt", "Brand"
		$CpuTestFailures -replace "cache_1_Results.txt", "Cache"
		$CpuTestFailures -replace "mmxsse_1_Results.txt", "MMXSSE"
		$CpuTestFailures -replace "imc_1_Results.txt", "IMC"
		$CpuTestFailures -replace "Math_PrimeNum_Parallel_Math_1_Results.txt", "Prime Number Generation"
		$CpuTestFailures -replace "Parallel_PrimeNum_1_Results.txt", "Prime Number Generation"
		$CpuTestFailures -replace "Math_PrimeNum_Parallel_PrimeNum_1_Results.txt", "Prime Number Generation"
		$CpuTestFailures -replace "Math_FP_Parallel_Math_1_Results.txt", "Floating Point Math"
		$CpuTestFailures -replace "Math_FP_Parallel_FP_1_Results.txt", "Floating Point Math"
		$CpuTestFailures -replace "Parallel_FP_1_Results.txt", "Floating Point Math"
		$CpuTestFailures -replace "AVX_Parallel_Math_1_Results.txt FMA3_Parallel_Math_1_Results.txt", "Math"
		$CpuTestFailures -replace "Parallel_GPUStressW_1_Results.txt", "Software Rendering Stress Test"
		$CpuTestFailures -replace "AVX_Parallel_GPUStressW_1_Results.txt" , "Software Rendering Stress Test"
		$CpuTestFailures -replace "FMA3_Parallel_GPUStressW_1_Results.txt", "Software Rendering Stress Test"
		$CpuTestFailures -replace "dgemm_1_Results.txt", "CPU Load Stressing"
		$CpuTestFailures -replace "cpufreq_1_Results.txt", "CPU Frequency Changing (Amd CPUs fail regularly)"
		$CpuTestFailures -replace "pch_1_Results.txt", "PCH"
		$CpuTestFailures -replace "spbc_1_Results.txt", "SPBC"
		$CpuTestFailures -replace "Temperature_Results.txt", "Tempurature"
	}	
	cpureporting
